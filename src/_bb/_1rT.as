...
public class _1rT extends _1b6 {

    public function _1rT(_arg1:Console) {
        super(_arg1);
    }
    ...
    public function explode(_arg1:Object, _arg2:int = 3, _arg3:int = 9):String {
        ...
        ;
        if ((_arg1 is String)) {
            return ((('"' + _0wf._0Fn((_arg1 as String))) + '"'));
        }
        ;
        ...
        for each (_local9 in _local6) {
            ...
            if (_local9.@access != "writeonly") {
                try {
                    _local8.push(this._0Vq(_arg1, _local7, _arg2, _arg3));
                } catch (e:Error) {
                }
                ;
            } else {
        ...
        try {
            for (_local11 in _arg1) {
                _local8.push(this._0Vq(_arg1, _local11, _arg2, _arg3));
            }
            ;
        } catch (e:Error) {
        }
        ;
        return ((((((((((((("<p" + _arg3) + ">{") + _0wf._1eQ(_arg1)) + "</p") + _arg3) + "> ") + _local8.join(", ")) + "<p") + _arg3) + ">}</p") + _arg3) + ">"));
    }

    public function _09J(_arg1:int, _arg2:int):String {
    ...
    private function _0Vq(_arg1, _arg2:String, _arg3:int, _arg4:int):String {
