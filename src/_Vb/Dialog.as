...
public class Dialog extends Sprite {
    ...
    public function _Mu(_arg1:String, _arg2:Object):void {
        this._1Ws.setStringBuilder(new _5R().setParams(_arg1, _arg2));
    }
    ...
    protected function initText(_arg1:String):void {
        ...
        var _local2:_5R = new _5R().setParams(_arg1).setPrefix('<p align="center">').setPostfix("</p>");
        if (this._1vH) {
            _local2.setParams(_arg1, this._1vH);
        }
        ;
    ...
    private function _Dl():void {
        if (this._1uT != null) {
            this.leftButton = new _1jP(16, this._1uT, 120);
            this.leftButton.addEventListener(MouseEvent.CLICK, this._ng);
        }
        ;
        if (this._1cK != null) {
            this.rightButton = new _1jP(16, this._1cK, 120);
