...
public class VentEffect extends _1S9 {

    private static const get:int = 50;
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        x_ = this.go_.x_;
        y_ = this.go_.y_;
        var _local3:int = int((this.lastUpdate_ / get));
        while (_local3 < int((_arg1 / get))) {
            _local4 = (_local3 * get);
            _local5 = (_0CH._mN(VentParticle) as VentParticle);
