...
public class ConfettiEffect extends _1S9 {

    public function ConfettiEffect(_arg1:_1ST, _arg2:_1ST, _arg3:int, _arg4:int, _arg5:Boolean = false) {
...
class ConfettiParticle extends Particle {
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        _jO((this.pathX_ + (this.xDeflect_ * _local3)), (this.pathY_ + (this.yDeflect_ * _local3)));
        return (true);
    }
