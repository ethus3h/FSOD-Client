...
public class ExplosionEffect extends _1S9 {
    ...
    public var _oc:Vector.<uint>;
    public var _1iX:int;

    override public function update(_arg1:int, _arg2:int):Boolean {
        var _local4:uint;
        var _local5:Particle;
        if (this._oc.length == 0) {
            return (false);
        }
        ;
        ...
        ;
        var _local3:int;
        while (_local3 < this._1iX) {
            _local4 = this._oc[int((this._oc.length * Math.random()))];
