...
public class LevelUpEffect extends _1S9 {

    private static const _1rb:int = 2000;
    ...
    override public function update(_arg1:int, _arg2:int):Boolean {
        ...
        ;
        var _local3:Number = ((_arg1 - this.startTime_) / _1rb);
        if (_local3 >= 1) {
            this._Ae();
            return (false);
        }
        ;
        this._0ZI(this.parts1_, 1, 0, _local3);
        this._0ZI(this.parts2_, 1, Math.PI, _local3);
        return (true);
    }

    public function _0ZI(_arg1:Vector.<LevelUpParticle>, _arg2:Number, _arg3:Number, _arg4:Number):void {
        var _local5:int;
