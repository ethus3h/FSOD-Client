...
public class GUID {
    ...
    public static function create():String {
        ...
        return (_0TV((((_local2 + _local4) + _local3) + counter++)).toUpperCase());
    }

    private static function _0TV(_arg1:String):String {
        return (_0M(_arg1));
    }

    private static function _0M(_arg1:String):String {
        return (_BQ(_1Hz(_1uN(_arg1), (_arg1.length * 8))));
    }

    private static function _1Hz(_arg1:Array, _arg2:Number):Array {
        var _local10:Number;
        var _local11:Number;
        var _local12:Number;
        var _local13:Number;
        ...
        while (_local9 < _arg1.length) {
            ...
            while (_local15 < 80) {
                ...
                ;
                _local16 = _6v(_6v(rol(_local4, 5), sha1_ft(_local15, _local5, _local6, _local7)), _6v(_6v(_local8, _local3[_local15]), sha1_kt(_local15)));
                _local8 = _local7;
                _local7 = _local6;
            ...
            ;
            _local4 = _6v(_local4, _local10);
            _local5 = _6v(_local5, _local11);
            _local6 = _6v(_local6, _local12);
            _local7 = _6v(_local7, _local13);
            _local8 = _6v(_local8, _local14);
            _local9 = (_local9 + 16);
        }
        ;
    ...
    private static function _6v(_arg1:Number, _arg2:Number):Number {
    ...
    private static function _1uN(_arg1:String):Array {
    ...
    private static function _BQ(_arg1:Array):String {
