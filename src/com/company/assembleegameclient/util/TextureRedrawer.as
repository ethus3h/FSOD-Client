...
public class TextureRedrawer {
    ...
    public static const _0Z:int = 12;
    public static const _tZ:int = (2 * _0Z);//24
    ...
    public static var _0Gf:BitmapData = null;
    private static var cache_:Dictionary = new Dictionary();
    private static var _0r6:Dictionary = new Dictionary();
    ...
    private static var colorTexture1:BitmapData = new _0Iy(1, 1, false);
    private static var colorTexture2:BitmapData = new _0Iy(1, 1, false);
    ...
    public static function redraw(_arg1:BitmapData, _arg2:int, _arg3:Boolean, _arg4:uint, _arg5:Boolean = true, _arg6:Number = 5):BitmapData {
        ...
        _local8 = _0R9._ud(_local8, _arg4, 1.4, _arg5);
        if (_arg5) {
    ...
    public static function resize(_arg1:BitmapData, _arg2:BitmapData, _arg3:int, _arg4:Boolean, _arg5:int, _arg6:int, _arg7:Number = 5):BitmapData {
        ...
        _local10.translate(_0Z, _0Z);
        var _local11:BitmapData = new _0Iy((_local8 + _tZ), ((_local9 + ((_arg4) ? _0Z : 1)) + _0Z), true, 0);
    ...
    public static function redrawSolidSquare(_arg1:uint, _arg2:int):BitmapData {
        ...
        ;
        _local4 = new _0Iy(((_arg2 + 4) + 4), ((_arg2 + 4) + 4), true, 0);
        _local4.fillRect(new Rectangle(4, 4, _arg2, _arg2), (0xFF000000 | _arg1));
        _local4.applyFilter(_local4, _local4.rect, PointUtil._0Q4, OUTLINE_FILTER);
    ...
    public static function _01(_arg1:BitmapData, _arg2:Number):BitmapData {
        if (_arg2 == 1) {
            return (_arg1);
        }
        ;
        var _local3:Dictionary = _0r6[_arg2];
        if (_local3 == null) {
            _local3 = new Dictionary();
            _0r6[_arg2] = _local3;
        }
    ...
    private static function getTexture(_arg1:int, _arg2:BitmapData):BitmapData {
        ...
        switch (_local4) {
            ...
            case 1:
                ...
                break;
            case 4:
                _local3 = AssetLibrary._Rb("textile4x4", _local5);
                break;
            case 5:
                _local3 = AssetLibrary._Rb("textile5x5", _local5);
                break;
            case 9:
                _local3 = AssetLibrary._Rb("textile9x9", _local5);
                break;
            case 10:
                _local3 = AssetLibrary._Rb("textile10x10", _local5);
                break;
            case 0xFF:
                _local3 = _0Gf;
                break;
    ...
    private static function retexture(_arg1:BitmapData, _arg2:BitmapData, _arg3:int, _arg4:int):BitmapData {
        ...
        _local5.scale(5, 5);
        var _local6:BitmapData = new _0Iy((_arg1.width * 5), (_arg1.height * 5), true, 0);
        ...
        _local6.applyFilter(_local6, _local6.rect, PointUtil._0Q4, new ShaderFilter(_local9));
        return (_local6);
    }
