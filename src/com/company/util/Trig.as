...
public class Trig {
    ...
    public static const _RN:Number = (180 / Math.PI);//57.2957795130823
    public static const _1HC:Number = (Math.PI / 180);//0.0174532925199433

    public static function _1Bw(_arg1:Number, _arg2:Number, _arg3:Number):Number {
    ...
    public static function _1Mz(_arg1:Number, _arg2:Number):Number {
        if (_arg1 > _arg2) {
            if ((_arg1 - _arg2) > Math.PI) {
    ...
    public static function _pc(_arg1:Number):Number {
        var _local2:int;
        if (_arg1 < -(Math.PI)) {
    ...
    public static function _EZ(_arg1:Number):Number {
        var _local2:int;
        if (_arg1 < -180) {
    ...
    public static function testFunc1(_arg1:Function, _arg2:Function):Boolean {
        ...
        var _local4:int;
        while (_local4 < 1000) {
            _local5 = (((_local3._0WC() % 2000) - 1000) + _local3._1mV());
    ...
    public static function testFunc2(_arg1:Function, _arg2:Function):Boolean {
        ...
        while (_local4 < 1000) {
            _local5 = (((_local3._0WC() % 2000) - 1000) + _local3._1mV());
            _local6 = (((_local3._0WC() % 2000) - 1000) + _local3._1mV());
