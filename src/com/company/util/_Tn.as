...
public class _Tn {
    ...
    public static function _0O3(_arg1:Rectangle, _arg2:Number, _arg3:Number):Number {
        ...
        ;
        return (PointUtil._1Ar(_local4, _local5, _arg2, _arg3));
    }

    public static function _1o(_arg1:Rectangle, _arg2:Number, _arg3:Number):Point {
        var _local4:Number = _arg2;
        var _local5:Number = _arg3;
        if (_local4 < _arg1.x) {
            _local4 = _arg1.x;
    ...
    public static function _0wL(_arg1:Rectangle, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number):Boolean {
        var _local8:Number;
        var _local9:Number;
        var _local10:Number;
        var _local11:Number;
    ...
    public static function _1Kj(_arg1:Rectangle, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number, _arg6:Point):Boolean {
        var _local7:Number;
        var _local8:Number;
        var _local9:Number;
        var _local10:Number;
    ...
    public static function _tK(_arg1:Rectangle, _arg2:IntPoint, _arg3:IntPoint):Point {
        var _local4:Number;
        var _local5:Number;
        var _local6:Number;
        var _local7:Number;
    ...
    public static function _1WA(_arg1:Number, _arg2:Number, _arg3:Number, _arg4:Number, _arg5:Number):_1hL {
        var _local9:Point;
        var _local11:int;
