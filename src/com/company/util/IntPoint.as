...
public class IntPoint {
    ...
    public static function _0nR():void {
        var _local1:UnitTest = new UnitTest();
    }

    public static function _0lF(_arg1:Point):IntPoint {
    ...
    public function _09z(_arg1:int):void {
        this.x_ = _arg1;
    }

    public function _14a(_arg1:int):void {
        this.y_ = _arg1;
    }
    ...
    public function _0C8(_arg1:IntPoint):Boolean {
        return ((((this.x_ == _arg1.x_)) && ((this.y_ == _arg1.y_))));
    }

    public function _18h(_arg1:IntPoint):int {
    ...
    public function _1sL(_arg1:IntPoint):Number {
        var _local2:int = (_arg1.x_ - this.x_);
        var _local3:int = (_arg1.y_ - this.y_);
        return (Math.sqrt(((_local2 * _local2) + (_local3 * _local3))));
    }

    public function _0dH(_arg1:Point):Number {
    ...
    public function _nK(_arg1:IntPoint):int {
        var _local2:int = (_arg1.x() - this.x_);
        var _local3:int = (_arg1.y() - this.y_);
    ...
    public function transform(_arg1:Matrix):IntPoint {
        var _local2:Point = _arg1.transformPoint(this._1Ab());
