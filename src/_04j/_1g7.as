...
public class _1g7 {
    ...
    public function _1g7(_arg1:Number, _arg2:Function, _arg3 = null, _arg4 = null, _arg5 = null, _arg6 = null, _arg7 = null, _arg8 = null, _arg9 = null, _arg10 = null) {
        this.f = _arg2;
        if (_arg3 != null) {
            this.data1 = _arg3;
        }
        ...
        ;
        this._1bd = new Timer((_arg1 * 1000), 1);
        this._1bd.addEventListener(TimerEvent.TIMER_COMPLETE, this._0TM);
        this._1bd.start();
    }
    ...
    private var data7;
    private var data8;
    private var _1bd:Timer;

    public function _0TM(_arg1:TimerEvent):void {
        this._1bd.removeEventListener(TimerEvent.TIMER_COMPLETE, this._0TM);
        if (this.data8 != null) {
