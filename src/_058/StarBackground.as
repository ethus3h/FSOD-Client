...
public class StarBackground extends Background {
    ...
    private function _1O2():void {
        var _local3:Star;
        var _local1:_0q = AssetLibrary._1dj("stars");
        var _local2:Star = new Star(((Math.random() * 1000) - 500), ((Math.random() * 1000) - 500), (4 * (0.5 + (0.5 * Math.random()))), _local1._1XN[int((_local1._1XN.length * Math.random()))]);
        for each (_local3 in this._hx) {
            if (PointUtil._1Ar(_local2.x_, _local2.y_, _local3.x_, _local3.y_) < 3) {
                return;
            }
            ;
        }
        ;
        this._hx.push(_local2);
    }
