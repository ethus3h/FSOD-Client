...
public class _Y4 {
    ...
    public static function _1Fk(_arg1:Number = 90, _arg2:Number = 1, _arg3:Number = 1, _arg4:Number = 0x0800):Matrix3D {
    ...
    public static function _K7(_arg1:ByteArray, _arg2:int):String {
        var _local5:uint;
        var _local3 = "";
        var _local4:int;
        while (_local4 < _arg2) {
    ...
    public static function _13h(_arg1:uint):uint {
        _arg1--;
        _arg1 = (_arg1 | (_arg1 >> 1));
        _arg1 = (_arg1 | (_arg1 >> 2));
        _arg1 = (_arg1 | (_arg1 >> 4));
