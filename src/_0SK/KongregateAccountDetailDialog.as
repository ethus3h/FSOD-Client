...
//_0SK.KongregateAccountDetailDialog
...
public class KongregateAccountDetailDialog extends Sprite {
    ...
    public function _0Pf(_arg1:String, _arg2:String, _arg3:Boolean):void {
        var _local4:Frame;
        _local4 = new Frame(_TG._set, "", _TG._Wo, "/kongregateCurrentLogin");
        addChild(_local4);
        this._13G = new _06T().setSize(18).setColor(0xB3B3B3);
        this._13G.setBold(true);
        this._13G.setStringBuilder(new _5R().setParams(_TG._set));
        ...
        if (_arg3) {
            ...
            this._0XS.setStringBuilder(new _5R().setParams(_TG._0kn));
            this._0XS.filters = [new DropShadowFilter(0, 0, 0)];
            this._0XS.y = (_local4.h_ - 60);
            this._0XS.x = 17;
            _local4.addChild(this._0XS);
            this._1f9 = new _06T().setSize(16).setColor(0xB3B3B3).setTextWidth(238).setTextHeight(30);
            ...
            this._20o = new _Wt(12, false, _TG._1QG);
