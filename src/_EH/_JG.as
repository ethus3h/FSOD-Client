...
public class _JG {
    ...
    private static var _0CE:Array;
    private static var _Bq:Boolean = false;
    ...
    public static function encode(_arg1:BitmapData):ByteArray {
        ...
        _local3.writeByte(0);
        _0No(_local2, 1229472850, _local3);
        ...
        ;
        _local4.compress();
        _0No(_local2, 1229209940, _local4);
        _0No(_local2, 1229278788, null);
        return (_local2);
    }

    private static function _0No(_arg1:ByteArray, _arg2:uint, _arg3:ByteArray):void {
        var _local8:uint;
        var _local9:uint;
        var _local10:uint;
        if (!_Bq) {
        ...
        while (_local7 < (_local6 - _local5)) {
            _local8 = uint((_0CE[((_local8 ^ _arg1.readUnsignedByte()) & uint(0xFF))] ^ uint((_local8 >>> 8))));
            _local7++;
        }
        ;
